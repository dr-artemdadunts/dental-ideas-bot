...
- "🎬 Reels 60 сек" → 4–5 битов с таймингом: хук → развитие → доказательство/
  пример → вывод
- "🎠 Карусель" → биты = слайды ("Слайд 1", "Слайд 2", ...), 5–7 слайдов;
  voiceover — КОРОТКИЙ текст самого слайда, 15–25 слов, крупным шрифтом,
  читается за 1–2 секунды, НЕ абзац; если нужно что-то развернуть — это идёт
  в visual как заметка дизайнеру, а не в текст слайда. visual — что на слайде
  визуально (иконка, диаграмма, крупная цифра и т.п.) + при необходимости
  более подробное пояснение мелким текстом
...
7. Если формат "🎠 Карусель" — voiceover каждого слайда 15–25 слов, не
   абзац? Если где-то длиннее — сократи текст слайда, а детали перенеси
   в visual.
